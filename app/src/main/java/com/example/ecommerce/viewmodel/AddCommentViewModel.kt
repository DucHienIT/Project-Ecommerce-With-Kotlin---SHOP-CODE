...
class AddCommentViewModel(private val addCommentRepository: AddCommentRepository, ) : BaseViewModel() {
    ...
    fun addComment(id: Int,access_token: String,text:String) {
        // Đặt giá trị của đối tượng progressbarLiveData là true để hiển thị tiến trình đang xử lý
        progressbarLiveData.value = true
        addCommentRepository.addComment(id,access_token,text)
            .singleHelper()
            ...
            .subscribe(object : Observer<Comment>(compositeDisposable) {
